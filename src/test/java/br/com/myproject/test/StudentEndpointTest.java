...
public class StudentEndpointTest {
	...
	static class Config {
		...
		public RestTemplateBuilder restTemplateBuilder() {
			return new RestTemplateBuilder().basicAuthorization("huelton", "12345");
			
		}
	}
	
	//teste para garantir erro 401 para o usuario divergente para o acesso.
	@Test
	...
	//teste para garantir erro 401 para o usuario divergente passado pela busca.
	@Test
	...
	//teste de lista para garantir acesso 200 para o usuario e senha correto.
    @Test
    public void listStudentsWhenUsernameAndPasswordAreCorrectShouldReturnStatusCode200() {
        ...
        System.out.println(restTemplate.withBasicAuth("huelton", "12345"));
